          ...
          <TabsContent value="financial">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="carEstimatedRange">
                    Autonomie estimée des voitures (km)
                  </Label>
                  <Input
                    id="carEstimatedRange"
                    name="carEstimatedRange"
                    type="text"
                    value={settings.estimatedRangeCar}
                    onChange={handleInputChange}
                    placeholder="Entrez l'autonomie estimée des voitures"
                  />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="motorbikeEstimatedRange">
                    AUtonomie estimée des motos (km)
                  </Label>
                  <Input
                    id="motorbikeEstimatedRange"
                    name="motorbikeEstimatedRange"
                    type="text"
                    value={settings.estimatedRangeMotorbike}
                    onChange={handleInputChange}
                    placeholder="Entrez l'autonomie estimée des motos"
                  />
                </div>
                <div className="space-y-2">
